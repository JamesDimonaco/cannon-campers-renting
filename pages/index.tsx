...
export default function Home() {
  return (
    <div className="bg-white">
        <Head>
        <title>cannon campers renting</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <header>
        <Popover className="relative bg-white">
          <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 ">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <a href="#">
                <span className="sr-only">Cannon campers</span>
                <img
                  className="h-8 w-auto sm:h-10"
                  src="https://cannoncamperconversions.com/wp-content/uploads/2017/03/header-logo.png"
                  alt=""
                />
              </a>
            </div>
            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              <div className="absolute inset-0">
                <img
                  ...
                  src="https://cannoncamperconversions.com/wp-content/uploads/2017/03/HEADER-1-Tmore-road-1680x1086.jpg"
